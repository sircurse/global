...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 7 then
			...
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 8 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 10 then
			...
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 11 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 15 then
			if player:getStorageValue(Storage.Quest.TheNewFrontier.BribeKing) == 1 and player:getStorageValue(Storage.Quest.TheNewFrontier.BribeLeeland) == 1 and player:getStorageValue(Storage.Quest.TheNewFrontier.BribeExplorerSociety) == 1 and player:getStorageValue(Storage.Quest.TheNewFrontier.BribeWydrin) == 1 and player:getStorageValue(Storage.Quest.TheNewFrontier.BribeTelas) == 1 and player:getStorageValue(Storage.Quest.TheNewFrontier.BribeHumgolf) == 1 then
		...
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 16 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 20 then
			...
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.Quest.TheNewFrontier.Questline) == 21 then
			npcHandler:say({
