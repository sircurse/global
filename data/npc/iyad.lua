...
local function addTravelKeyword(keyword, text, cost, destination)
	if keyword == 'farmine' then
		keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Never heard about a place like this.'}, function(player) return player:getStorageValue(Storage.Quest.TheNewFrontier.Mission10) ~= 1 end)
	end
...
keywordHandler:addKeyword({'transport'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia}, to {Edron}, to {Kazordoon}, to Z... Zao, to the F...{Femor Hills} or to {Issavi} if you like. W....Where do you want to go?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia}, to {Edron}, to {Kazordoon}, to Z... Zao, to the F...{Femor Hills} or to {Issavi} if you like. W....Where do you want to go?'})
keywordHandler:addKeyword({'ride'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia}, to {Edron}, to {Kazordoon}, to Z... Zao, to the F...{Femor Hills} or to {Issavi} if you like. W....Where do you want to go?'})
...
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'I can fly you to {Darashia}, to {Edron}, to {Kazordoon}, to the F...{Femor Hills} or to {Issavi} if you like. W....Where do you want to go?'})
