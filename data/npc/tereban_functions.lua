	...
	if npcHandler:getTopic(playerId) == 0 then
		if MsgContains(message, "cloak") then
			if player:getStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1]) == 12 then
				...
				player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01[1], 13)
				player:setStorageValue(Storage.Quest.ThreatenedDreams.Mission01.FeathersCount, 0) -- Start Mission 'Tattered Swan Feathers'
			else
